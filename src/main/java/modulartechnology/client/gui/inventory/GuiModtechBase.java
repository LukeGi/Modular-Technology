...
{
    protected ResourceLocation texture = new ResourceLocation(ModInfo.MOD_ID, "");
    protected ResourceLocation overlay = new ResourceLocation(ModInfo.MOD_ID, "textures/inventory/overlay.png");
    ...
    {
        this.texture = new ResourceLocation(ModInfo.MOD_ID, "textures/inventory" + (file.startsWith("/") ? "" : "/") + file + (file.endsWith(".png") ? "" : ".png"));
        return this;
    }
