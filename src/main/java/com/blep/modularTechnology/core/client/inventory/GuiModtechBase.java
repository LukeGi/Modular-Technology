package com.blep.modularTechnology.core.client.inventory;
...
public abstract class GuiModtechBase extends GuiContainer
{
    ...
    protected ResourceLocation overlay = new ResourceLocation(ModularTechnology.MOD_ID, "textures/inventory/overlay.png");
    ...
    {
        this.texture = new ResourceLocation(ModularTechnology.MOD_ID, "textures/inventory" + (file.startsWith("/") ? "" : "/") + file + (file.endsWith(".png") ? "" : ".png"));
        return this;
    }
