...
public class ContainerTreeFarm extends Container
{
    ...
    private TileEntityTreeFarm tileEntityTreeFarm;

    public ContainerTreeFarm(InventoryPlayer invPlayer, TileEntityTreeFarm tileEntityTreeFarm)
    {
        this.tileEntityTreeFarm = tileEntityTreeFarm;

        final int SLOT_X_SPACING = 18;
        final int SLOT_Y_SPACING = 18;
        final int HOTBAR_XPOS = 32;
        ...
        final int PLAYER_INVENTORY_XPOS = 32;
        ...
        if (TE_INVENTORY_SLOT_COUNT != tileEntityTreeFarm.getSizeInventory())
        {
            System.err.println("Mismatched slot count in ContainerBasic(" + TE_INVENTORY_SLOT_COUNT
                    + ") and TileInventory (" + tileEntityTreeFarm.getSizeInventory() + ")");
        }
        final int TILE_INVENTORY_XPOS = 10;
        final int TILE_INVENTORY_YPOS = 23;
        slotnum = 0;
        ...
        for (int y = 0; y < TE_INVENTORY_ROW_COUNT; y++)
        {
            ...
            {
                addSlotToContainer(new Slot(tileEntityTreeFarm, slotnum++, TILE_INVENTORY_XPOS + SLOT_X_SPACING * x, TILE_INVENTORY_YPOS + SLOT_Y_SPACING * y));
            }
        }
    }
    ...
    {
        return tileEntityTreeFarm.isUseableByPlayer(player);
    }
    ...
    public void onContainerClosed(EntityPlayer playerIn)
    {
        ...
        this.tileEntityTreeFarm.closeInventory(playerIn);
    }
}
